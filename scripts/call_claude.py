...
- **반드시 의견·결론을 먼저 쓰고, 그 근거 데이터를 뒤에 서술한다**
  예시(나쁜): "나스닥이 +1.5% 올랐어요. 코스피 IT 섹터에 긍정적이에요."
  예시(좋은): "코스피 IT 섹터 갭 상승 가능성이 높아요. 나스닥 <b>+1.5%</b>로 기술주 전반 강세예요."
- 지표·수치는 반드시 <b>수치</b> 형식으로 강조
- 문체: 반드시 '~해요', '~예요', '~있어요' 등 해요 체로 작성
...
- 각 항목은 **150자 이내**. 이모지 1개로 시작
- **반드시 의견·결론을 먼저 쓰고, 그 근거 데이터를 뒤에 서술한다**
  예시(나쁜): "S&P500 선물이 -0.3% 하락했어요. 프리마켓이 약세예요."
  예시(좋은): "약세 개장 가능성이 높아요. S&P500 선물 <b>-0.3%</b>, 미·이란 긴장 재고조예요."
- 지표·수치는 반드시 <b>수치</b> 형식으로 강조
- 문체: 반드시 '~해요', '~예요', '~있어요' 등 해요 체로 작성

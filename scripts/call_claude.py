...
**[필수 규칙 7] Fear & Greed 지수(공포탐욕지수) 수치는 절대 언급 금지**
Fear & Greed 지수는 실시간 데이터를 제공받지 않으므로, 수치를 기재하거나 추정하는 것을 금지한다.
이는 브리핑 본문(reasons, scenario, action_guide 등) 어디서도 예외 없이 적용된다.
투자 심리를 표현할 때는 VIX·선물 방향·아시아 증시 등 제공된 지표로 대체한다.
❌ 금지: "Fear & Greed 지수 XX", "공포탐욕지수 XX", "투자 심리 지표 XX점"
✅ 허용: "투자 심리가 개선됐어요", "VIX가 하락하며 시장 불안이 줄었어요"

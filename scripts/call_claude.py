...
- 💹 빅테크·섹터 수급 — 매그니피센트7(NVDA·AAPL·MSFT·GOOGL·AMZN·META·TSLA) + 브로드컴(AVGO)·AMD 등 시총 상위 대형주 큰 등락(±2% 이상)
...
- **주도주 기업 이벤트 우선**: 매그니피센트7(NVDA·AAPL·MSFT·GOOGL·AMZN·META·TSLA)·브로드컴(AVGO)·AMD 등 시총 상위 빅테크의 실적·가이던스·신제품·M&A·대형 계약·소송·감원 같은 촉매가 있으면 근거로 우선 다룬다.

...

{
  ...
  "reasons": [
    "🚀 나스닥은 <b>+X.X%</b>로 마감하며 기술주가 전반적으로 강세를 보였습니다. MSFT는 <b>+X.X%</b>로 MA20을 돌파했고, 코스피 IT·플랫폼 섹터의 갭 상승을 기대할 근거가 됩니다.",
    "💡 필라델피아 반도체 지수 SOX는 <b>+X.X%</b>로 연속 강세입니다. SK하이닉스·삼성전자 시초가에 상승 압력이 작용할 여지가 있습니다.",
    "🇺🇸 한국 ETF EWY는 <b>+X.X%</b>로 상승했고, 달러/원은 <b>X,XXX원</b>으로 원화 강세입니다. 외국인 순매수 환경이 조성되고 있습니다.",
    "😰 공포탐욕지수는 <b>XX</b>로 극단적 공포 구간에 있습니다. 단기 역발상 매수 기회가 될 수 있으나, 추세 확인이 선행돼야 합니다."
  ],
  "stock_picks": [
    {
      "name": "종목명",
...

{
  ...
  "reasons": [
    "🌏 아시아 증시는 일본 <b>+X.X%</b>, 한국 <b>+X.X%</b>로 동반 강세를 보이며 리스크온 분위기가 형성됐습니다.",
    "📈 S&P500 선물은 <b>+X.X%</b>, NQ 선물은 <b>+X.X%</b>로 프리마켓이 강하게 출발하고 있습니다.",
    "😰 VIX는 <b>XX.X</b>로 전일 대비 하락하며 변동성 완화 신호를 보이고 있습니다.",
    "🏦 미국채 10년물은 <b>X.XX%</b>로 안정세를 유지하며 성장주에 우호적인 매크로 환경이 이어지고 있습니다.",
    "💹 NVDA는 프리마켓에서 <b>+X.X%</b>로 강세를 보이고, 반도체 섹터 전반의 매수세가 집중될 가능성이 있습니다."
  ],
  "stock_picks": [
    {
      "name": "NVDA (엔비디아)",

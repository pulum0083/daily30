...
- 🏦 금리·연준·달러(DXY) — 10년물 금리 급등락(±5bp 이상) 또는 FOMC 발언
...
- 🏦 금리·연준·달러 — 10년물 금리 급등락(±5bp), FOMC 발언, CPI·PCE 결과
...
- 종목명을 key로, **2~3개 문장(총 80~180자)** 급등 사유를 value로 작성
...
- 2번째 문장: 시장·섹터 맥락 또는 수급/거래량 근거 (필수) — 어떤 섹터가 동반 강세였는지, 외국인/기관/개인 중 누가 매수했는지, 거래량이 어떻게 변했는지 등
- 3번째 문장: 추가 컨텍스트나 향후 관전 포인트 (선택, 있을 때만)
...

{
  ...
  "top_gainers_reasons": {
    "에이프로젠": "한화그룹 인수 협상 진전 소식이 직접적인 모멘텀이 됐어요. 바이오 섹터 전반이 약세였는데도 인수 시너지 기대감이 매수세를 끌어왔거든요. 거래량이 평소 대비 6배 이상 폭증하며 단기 수급도 강하게 붙었어요.",
    "SK하이닉스": "엔비디아 실적 서프라이즈로 HBM 수요 확대 기대가 살아났어요. 반도체 대표주 섹터 전반이 동반 강세를 보였고, 외국인이 순매수로 전환하며 매수세가 집중됐거든요.",
    "삼성전자": "메모리 가격 반등 신호에 외국인 매수가 몰렸어요. HBM 경쟁 우위 회복 기대감도 함께 작용하며 반도체 업황 전반의 턴어라운드 시그널로 해석됐어요."
  },
  "telegram_signals": [

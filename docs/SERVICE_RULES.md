...
장중(09:00~15:30)은 결론(곡선)·강도·주도권·수급 4장(`vs=intraday`). **마감 후(15:31~21:19)는 메인 곡선(결론·곡선·근거 줄)만**(`vs=close`) — 2026-09-17 결정, 2026-09-22에 미국 브리핑 발행(브리핑 스트립 us 슬롯 21:20, §13)까지 늘렸다. 17:00에 '밤사이 미국 반도체 시황'이 위로 올라오면 곡선은 **섹터별 대표 종목 바로 위**로 내려간다(`stocks-home.js` 국면 재배치).
**밤(21:20~07:29)은 카드 없음**(2026-09-17 사용자 결정 — 처음엔 강도 1장을 남겼지만 뺐다). 대결판 API도 부르지 않는다. 주말은 카드 없음. `slotOf`는 로컬

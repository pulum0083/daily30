...
장중(09:00~15:30)은 결론(곡선)·강도·주도권·수급 4장(`vs=intraday`). **마감 후(15:31~16:59)는 메인 곡선(결론·곡선·근거 줄)만**(`vs=close`) — 2026-09-17 사용자 결정. 17:00에 '밤사이 미국 반도체 시황'이 위로 올라오면 곡선은 빠진다.
**밤(17:00~07:29)은 카드 없음**(2026-09-17 사용자 결정 — 처음엔 강도 1장을 남겼지만 뺐다). 17:00부터는 '밤사이 미국 반도체 시황'만 보이고, 대결판 API도 부르지 않는다. 주말은 카드 없음. `slotOf`는 로컬

...
**대결판은 오늘 값을 다시 적지 않는다.** LIVE 지수바와 같은 지표(코스피 등락률·수급)를 대결판도
보여주면 한 화면에서 숫자가 갈린다 — 장중엔 LIVE가 실시간, 대결판이 확정 1분봉이라 약 2분 시차
(13:24~13:30 사이 +1.04~+1.24%), 마감 후엔 LIVE 수급에 애프터장이 섞인다(§51 남은 갭, 9/15 확정
−11,863/+12,116/−16,825 vs LIVE −11,820/+12,173/−16,861). 값이 틀린 게 아니라 시점이 다른 것이다
(13:28 LIVE `+1.10%`는 확정 13:28 봉과 정확히 일치). 그래서 근거 줄은 "어제 이 시각엔 −0.78%였어요.
지금은 +1.81%p 더 높아요" 형태만 쓴다.

**마감 후 데이터 규칙(§48·§51 재확인)**: 기준가는 직전 거래일 **15:30 1분봉**. 마감 후 수급은
**15:31~15:40 행** — 이 행으로 뽑은 9/15 수급(외국인 −15,711억 · 기관 −9,040억 · 개인 +8,320억)이
그날 마감 브리핑 발행값과 정확히 일치해 교차 검증됐다. 16:00 이후 실시간·일봉은 애프터장이 섞여
쓰지 않는다(§48). `status:'early'`는 15:30~15:39(수급 집계 공백)에 뜬다.
